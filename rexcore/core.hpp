...
#define REX_CORE_TRACE_FUNC() REX_CORE_TRACE_NAMED(__FUNCTION__)
#define REX_CORE_TRACE_NAMED(name) if (!std::is_constant_evaluated()) { PERFORMANCEAPI_INSTRUMENT(name); }
#else
